        ...
        <div className="sticky bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 z-20 shadow-lg">
          <div className="flex gap-2">
            <button
              type="button"
              onClick={handleClose}
              className="flex-1 bg-gray-200 text-gray-700 py-3 rounded-lg text-xs font-medium hover:bg-gray-300 transition-colors"
            >
              Cancel
            </button>
            <button
              ...
              disabled={saving}
              className="flex-1 bg-primary-600 text-white py-3 rounded-lg text-xs font-medium hover:bg-primary-700 transition-colors disabled:opacity-50 shadow-sm"
            >
              {saving ? 'Saving...' : 'Save'}
            </button>
          </div>
