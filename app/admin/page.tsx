      ...
      <div className="p-4">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <button
            ...
            disabled={generating}
            className="w-full bg-primary-600 text-white py-3 rounded-lg text-[10px] font-medium hover:bg-primary-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {generating ? (
              <>
