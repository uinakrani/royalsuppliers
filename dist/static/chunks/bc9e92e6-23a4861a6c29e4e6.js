"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{99978:function(e,t,r){r.d(t,{AK:function(){return deleteField},Bt:function(){return serverTimestamp},EK:function(){return Timestamp},ET:function(){return addDoc},IO:function(){return query},JU:function(){return doc},PL:function(){return getDocs},QT:function(){return getDoc},Xo:function(){return orderBy},ad:function(){return getFirestore},ar:function(){return where},cf:function(){return onSnapshot},hJ:function(){return collection},oe:function(){return deleteDoc},qs:function(){return writeBatch},r7:function(){return updateDoc}});var n,i,s,a,o=r(63991),l=r(45538),u=r(56914),c=r(8745),_=r(53172),h=r(44203);r(62601);var d=r(40263).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let F="WebChannelConnection";let __PRIVATE_WebChannelConnection=class __PRIVATE_WebChannelConnection extends class{constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;let t=e.ssl?"https":"http",r=encodeURIComponent(this.databaseId.projectId),n=encodeURIComponent(this.databaseId.database);this.Do=t+"://"+e.host,this.vo=`projects/${r}/databases/${n}`,this.Co="(default)"===this.databaseId.database?`project_id=${r}`:`project_id=${r}&database_id=${n}`}get Fo(){return!1}Mo(e,t,r,n,i){let s=__PRIVATE_generateUniqueDebugId(),a=this.xo(e,t.toUriEncodedString());__PRIVATE_logDebug("RestConnection",`Sending RPC '${e}' ${s}:`,a,r);let o={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(o,n,i),this.No(e,a,o,r).then(t=>(__PRIVATE_logDebug("RestConnection",`Received RPC '${e}' ${s}: `,t),t),t=>{throw __PRIVATE_logWarn("RestConnection",`RPC '${e}' ${s} failed with error: `,t,"url: ",a,"request:",r),t})}Lo(e,t,r,n,i,s){return this.Mo(e,t,r,n,i)}Oo(e,t,r){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+f}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((t,r)=>e[r]=t),r&&r.headers.forEach((t,r)=>e[r]=t)}xo(e,t){let r=b[e];return`${this.Do}/v1/${t}:${r}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}No(e,t,r,n){let i=__PRIVATE_generateUniqueDebugId();return new Promise((s,a)=>{let o=new h.JJ;o.setWithCredentials(!0),o.listenOnce(h.tw.COMPLETE,()=>{try{switch(o.getLastErrorCode()){case h.jK.NO_ERROR:let t=o.getResponseJson();__PRIVATE_logDebug(F,`XHR for RPC '${e}' ${i} received:`,JSON.stringify(t)),s(t);break;case h.jK.TIMEOUT:__PRIVATE_logDebug(F,`RPC '${e}' ${i} timed out`),a(new FirestoreError(E.DEADLINE_EXCEEDED,"Request time out"));break;case h.jK.HTTP_ERROR:let r=o.getStatus();if(__PRIVATE_logDebug(F,`RPC '${e}' ${i} failed with status:`,r,"response text:",o.getResponseText()),r>0){let e=o.getResponseJson();Array.isArray(e)&&(e=e[0]);let t=null==e?void 0:e.error;if(t&&t.status&&t.message){let e=function(e){let t=e.toLowerCase().replace(/_/g,"-");return Object.values(E).indexOf(t)>=0?t:E.UNKNOWN}(t.status);a(new FirestoreError(e,t.message))}else a(new FirestoreError(E.UNKNOWN,"Server responded with status "+o.getStatus()))}else a(new FirestoreError(E.UNAVAILABLE,"Connection failed."));break;default:fail()}}finally{__PRIVATE_logDebug(F,`RPC '${e}' ${i} completed.`)}});let l=JSON.stringify(n);__PRIVATE_logDebug(F,`RPC '${e}' ${i} sending request:`,n),o.send(t,"POST",l,r,15)})}Bo(e,t,r){let i=__PRIVATE_generateUniqueDebugId(),s=[this.Do,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=(0,h.UE)(),o=(0,h.FJ)(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},u=this.longPollingOptions.timeoutSeconds;void 0!==u&&(l.longPollingTimeout=Math.round(1e3*u)),this.useFetchStreams&&(l.useFetchStreams=!0),this.Oo(l.initMessageHeaders,t,r),l.encodeInitMessageHeaders=!0;let c=s.join("");__PRIVATE_logDebug(F,`Creating RPC '${e}' stream ${i}: ${c}`,l);let _=a.createWebChannel(c,l),d=!1,m=!1,f=new __PRIVATE_StreamBridge({Io:t=>{m?__PRIVATE_logDebug(F,`Not sending because RPC '${e}' stream ${i} is closed:`,t):(d||(__PRIVATE_logDebug(F,`Opening RPC '${e}' stream ${i} transport.`),_.open(),d=!0),__PRIVATE_logDebug(F,`RPC '${e}' stream ${i} sending:`,t),_.send(t))},To:()=>_.close()}),__PRIVATE_unguardedEventListen=(e,t,r)=>{e.listen(t,e=>{try{r(e)}catch(e){setTimeout(()=>{throw e},0)}})};return __PRIVATE_unguardedEventListen(_,h.ii.EventType.OPEN,()=>{m||(__PRIVATE_logDebug(F,`RPC '${e}' stream ${i} transport opened.`),f.yo())}),__PRIVATE_unguardedEventListen(_,h.ii.EventType.CLOSE,()=>{m||(m=!0,__PRIVATE_logDebug(F,`RPC '${e}' stream ${i} transport closed`),f.So())}),__PRIVATE_unguardedEventListen(_,h.ii.EventType.ERROR,t=>{m||(m=!0,__PRIVATE_logWarn(F,`RPC '${e}' stream ${i} transport errored:`,t),f.So(new FirestoreError(E.UNAVAILABLE,"The operation could not be completed")))}),__PRIVATE_unguardedEventListen(_,h.ii.EventType.MESSAGE,t=>{var r;if(!m){let s=t.data[0];s||fail();let a=s.error||(null===(r=s[0])||void 0===r?void 0:r.error);if(a){__PRIVATE_logDebug(F,`RPC '${e}' stream ${i} received error:`,a);let t=a.status,r=function(e){let t=n[e];if(void 0!==t)return __PRIVATE_mapCodeFromRpcCode(t)}(t),s=a.message;void 0===r&&(r=E.INTERNAL,s="Unknown error status: "+t+" with message "+a.message),m=!0,f.So(new FirestoreError(r,s)),_.close()}else __PRIVATE_logDebug(F,`RPC '${e}' stream ${i} received:`,s),f.bo(s)}}),__PRIVATE_unguardedEventListen(o,h.ju.STAT_EVENT,t=>{t.stat===h.kN.PROXY?__PRIVATE_logDebug(F,`RPC '${e}' stream ${i} detected buffering proxy`):t.stat===h.kN.NOPROXY&&__PRIVATE_logDebug(F,`RPC '${e}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{f.wo()},0),f}};function getDocument(){return"undefined"!=typeof document?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
